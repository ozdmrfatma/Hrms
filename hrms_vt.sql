...
CREATE TABLE public.candidates(
	...
	birth_year INT NOT NULL,--sadece dogum yılını istemis
...
CREATE TABLE public.verification_code_candidates(
	...
	CONSTRAINT pk_verification_code_candidate PRIMARY KEY(id),
...
CREATE TABLE public.employee_confirm_employers(
	...
	CONSTRAINT fk_employee_confirm_employers_employers FOREIGN KEY(id) REFERENCES public.employers(id)
);
